function funcDarkModeToggle() {
	...
	if (localStorage.getItem("darkmode") == "true") {
		...
		document.getElementById("server_booking_icon_reserved").innerHTML = '<image height="30" width="30" href="/assets/server-booked-light.png" />';
		document.getElementById("server_booking_icon_free").innerHTML = '<image height="30" width="30" href="/assets/server-un-booked-light.png" />';
	}
	else {
		...
		document.getElementById("server_booking_icon_reserved").innerHTML = '<image height="30" width="30" href="/assets/server-booked-dark.png" />';
		document.getElementById("server_booking_icon_free").innerHTML = '<image height="30" width="30" href="/assets/server-un-booked-dark.png" />';
	}
}
