function funcDarkModeToggle() {
	...
	if (localStorage.getItem("darkmode") == "true") {
		...
		document.getElementById("remove_server_icon").innerHTML = '<image height="40" width="40" href="/assets/delete_server_light.png" />';
		document.getElementById("view_server_icon").innerHTML = '<image height="40" width="40" href="/assets/view_server_light.png" />';
	}
	else {
		...
		document.getElementById("remove_server_icon").innerHTML = '<image height=40" width="40" href="/assets/delete_server_dark.png" />';
		document.getElementById("view_server_icon").innerHTML = '<image height="40" width="40" href="/assets/view_server_dark.png" />';
	}
}
